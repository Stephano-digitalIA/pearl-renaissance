  ...
  <section id="histoire" className="py-24 bg-ocean-dark text-primary-foreground relative overflow-hidden">
    <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
      ...
      <div className="order-1 md:order-2">
        <span className="text-sand-gold uppercase tracking-[0.2em] text-sm mb-4 block">Notre Héritage</span>
        <h2 className="font-serif text-4xl md:text-5xl mb-6 leading-tight">
          Un Trésor né du <br/>Mariage de l'Homme <br/>et de la Nature
        </h2>
        <p className="text-gray-400 font-light leading-relaxed mb-6">
          Chaque perle que nous proposons a passé au moins deux ans dans les lagons protégés de l'archipel des Tuamotu. C'est le temps nécessaire pour que la nacre se forme, couche après couche, offrant ces reflets uniques au monde.
        </p>
        <p className="text-gray-400 font-light leading-relaxed mb-8">
          Nous collaborons directement avec des fermes perlières familiales, garantissant non seulement une qualité exceptionnelle, mais aussi le respect de l'écosystème marin fragile de nos îles.
        </p>
        <a 
          href="#" 
